...
<footer class="footer mt-auto py-3 bg-warning">
  <div class="container">
    <p class="text-center text-white fg mt-3">Made With <i class="bi bi-heart-fill text-danger"></i>&nbsp;By&nbsp; <b><a href="#" class="link-sos pl-3" style="text-decoration: none;">Edo Rahayu</a></b></p>
  </div>
</footer>
<!-- Ini Akhir Footer-->
